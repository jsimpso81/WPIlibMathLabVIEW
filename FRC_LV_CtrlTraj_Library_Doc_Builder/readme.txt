...
4) OPen doc builder lv project

5) run gen_trajlib_doc

6) Create text files of VI html.  There is a batch file to do this.

7) run gen_trajlib_doc_enum

8) run gen_tranlib_doc_typedef

9) Update build_help_category_and_functon_list spreadsheet (.ods) file.
