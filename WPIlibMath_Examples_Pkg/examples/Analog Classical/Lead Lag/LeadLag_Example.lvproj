...
<Project Type="Project" LVVersion="19008000">
	...
	<Property Name="NI.Project.Description" Type="Str">mplements a classical control lead / lag algorithm.   The lead and lag time constants are specified.  If either of the time constrants is zero then that particular function is not performed.  This can be used as a filter.  It can also be used as a filtered "kicker" circuit to reduce process lag times when the setpoint changes from one value to another.</Property>
...
&lt;nidna:ExampleProgram 
    ...
    ContentType="EXAMPLE" 
&lt;Title&gt;
	&lt;Text Locale="US"&gt;LeadLag_Example.lvproj&lt;/Text&gt;
&lt;/Title&gt;
&lt;Description&gt;
	&lt;Text Locale="US"&gt;mplements a classical control lead / lag algorithm.   The lead and lag time constants are specified.  If either of the time constrants is zero then that particular function is not performed.  This can be used as a filter.  It can also be used as a filtered "kicker" circuit to reduce process lag times when the setpoint changes from one value to another.&lt;/Text&gt;
&lt;/Description&gt;
&lt;Keywords&gt;
	&lt;Item&gt;lead&lt;/Item&gt;
	&lt;Item&gt;lag&lt;/Item&gt;
...
&lt;/RequiredSoftware&gt;</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="LeadLag_Example.vi" Type="VI" URL="../VIs/LeadLag_Example.vi"/>
